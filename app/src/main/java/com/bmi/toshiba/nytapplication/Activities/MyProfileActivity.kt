...
class MyProfileActivity : BaseActivity() {
    ...
    private fun updateUserProfileData() {
        ...
        if (et_fname.text.toString() != mUserDetails.fname) {
            userHashMap[Constants.NAME] = et_fname.text.toString()
        }
        if (et_lname.text.toString() != mUserDetails.lname) {
            userHashMap[Constants.NAME] = et_lname.text.toString()
        }
        Constants.flName = et_fname.text.toString() + et_lname.text.toString()
